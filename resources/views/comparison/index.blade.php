                    ...
                    <tbody class="divide-y divide-slate-100">
                        @php
                            $rows = [
                                ...
                                ['label'=>'Jumlah Penduduk',     'v1'=> $c1['model']->population ? number_format($c1['model']->population) : 'N/A',      'v2'=> $c2['model']->population ? number_format($c2['model']->population) : 'N/A', 'icon' => 'fa-users'],
                                ['label'=>'PDB Terbaru',         'v1'=> $c1['gdp'] && $c1['gdp']->gdp_value ? '$'.number_format($c1['gdp']->gdp_value / 1e12, 3).' T' : 'N/A', 'v2'=> $c2['gdp'] && $c2['gdp']->gdp_value ? '$'.number_format($c2['gdp']->gdp_value / 1e12, 3).' T' : 'N/A', 'icon' => 'fa-vault'],
                                ...
                                ['label'=>'Kurs (1 USD)',        'v1'=> $c1['rate'] && $c1['rate']->exchange_rate !== null ? number_format($c1['rate']->exchange_rate, 2).' '.$c1['model']->currency_code : 'N/A', 'v2'=> $c2['rate'] && $c2['rate']->exchange_rate !== null ? number_format($c2['rate']->exchange_rate, 2).' '.$c2['model']->currency_code : 'N/A', 'icon' => 'fa-scale-balanced'],
